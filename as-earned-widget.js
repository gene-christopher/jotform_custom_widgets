...
class AsEarnedAgentLookupWidget {
    ...
    populateFormFields(agentData) {
        ...
        if (agentName) {
            console.log('As Earned Agent Lookup Widget: Setting q4_as_earned_AgentName field to:', agentName);
            this.setFieldValue('q4_as_earned_AgentName', agentName);
        } else {
    ...
    clearFields() {
        ...
        this.setFieldValue('q4_as_earned_AgentName', '');
    }
}
